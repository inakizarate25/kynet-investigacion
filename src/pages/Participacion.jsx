      ...
      <section className="relative bg-gray-100 py-20 px-6">
        <div className="mx-auto max-w-6xl rounded-lg bg-white p-10 shadow-lg">
          ...
          <div className="grid gap-8 md:grid-cols-2 text-gray-600 leading-relaxed text-lg">
            <p>
              Participar en un ensayo clínico es un proceso que requiere máxima
              responsabilidad y cuidado. Cada estudio está diseñado bajo
              estrictos protocolos internacionales para garantizar la seguridad
              de los pacientes y la validez científica de los resultados.
              <br />
              <br />
              Antes de comenzar, se evalúan detalladamente todos los riesgos y
              beneficios potenciales, y se siguen lineamientos establecidos por
              autoridades regulatorias como ANMAT, FDA y EMA.
            </p>
        ...
        <div className="mx-auto max-w-4xl space-y-12 text-gray-700">
          ...
          <div>
            ...
            <p className="text-lg">
              ...
              investigadores en personas voluntarias para comprobar la eficacia
              y seguridad de nuevos medicamentos, procedimientos, dispositivos o
              vacunas. Está supervisado y aprobado por las autoridades de salud.
            </p>
          </div>

          {/* Item */}
          <div>
            <h2 className="mb-2 text-2xl font-semibold">¿Para qué se hace?</h2>
            <div className="mb-4 h-1 w-16 bg-[#e2ec55]" />
            <p className="text-lg">
          ...
          <div>
            ...
            <div className="mb-4 h-1 w-16 bg-[#e2ec55]" />
            <p className="text-lg">
              Sí. Nuestros estudios se encuentran en su mayoría entre las fases
              2 y 4. Un Comité de Ética Independiente supervisa la seguridad de
              los pacientes y el cumplimiento de las Buenas Prácticas Clínicas,
              protegiendo los derechos de los participantes.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="mb-4 h-1 w-16 bg-[#e2ec55]" />
            <p className="text-lg">
              Significa participar de manera libre y voluntaria en un estudio de
              investigación. El paciente recibe toda la información del ensayo y
              decide libremente su participación, pudiendo retirarse en
              cualquier momento.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-lg">
              ...
              última generación y atención médica gratuita a través de un equipo
              multidisciplinario que cuida el bienestar del paciente.
            </p>
          </div>
        </div>
      </section>
